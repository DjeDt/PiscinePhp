		...
		<div style="text-align:center">
			...
			<?php
				...
				if ($account)
				{
					...
					{
						if (array_search($value['article_nom'], $liste_nom) === FALSE)
						{
							array_push($liste_nom, $value['article_nom']);
			...
			<form method="POST" action="modifier_article.php">
				<div>
					...
					<br />
					Nom de l'article à modifier : <input type="text" name="article_nom" value=""/>
				</div>
