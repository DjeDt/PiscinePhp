		...
		<div style="text-align:center">
			...
			<form method="POST" action="modifier_categorie.php">
				<div>
					...
					<br />
					Nom de la catégorie à modifier : <input type="text" name="old_article_categorie" value=""/>
					<br />
					Nouveau nom de la catégorie : <input type="text" name="new_article_categorie" value=""/>
				</div>
